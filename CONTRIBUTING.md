...
2. 고정 Owner/Assignee는 두지 않습니다. 현재 ADR 0011의 담당자 1명 + AI 보조 검토를 적용합니다. 독립 인간 검토가 실제 수행되지 않았다면 수행한 것으로 표시하지 않습니다.
3. `main`에 직접 작업하지 않고 Issue 번호를 포함한 브랜치를 만듭니다.
4. 작은 PR로 제출하고 수행한 검토의 주체·범위·한계를 기록합니다. 최종 원고 승인과 제출은 참가 팀의 확인 사항입니다.
