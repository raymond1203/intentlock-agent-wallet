...
## 4. 다음 호출을 허용하기 전에, 누적 효과를 계산한다

![IntentLock 검증 구조](../figures/editorial/architecture.png)

Source: 본 연구의 구현 경계와 설계. 선택적 의도 계약 생성, 주 오프라인 재생 평가와 별도 서명 경계 구현을 구분해 도식화.

### 4.1 사용자가 확인할 것은 계획이 아니라 경제적 조건이다
...
### 4.4 응답이 없다는 이유로 예산을 다시 풀어서는 안 된다
...
![보안과 정상 완료의 관계](../figures/editorial/security-utility.png)
...
![시스템별 오류 유형](../figures/editorial/error-taxonomy.png)
...
![시스템별 지연 시간](../figures/editorial/latency.png)
