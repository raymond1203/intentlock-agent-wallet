...
![IntentLock 연구 표지](../figures/visual-v2/cover.png)
...
![호출별 허용과 누적 예산 검사의 차이](../figures/visual-v2/cumulative-budget.png)
...
![IntentLock 검증 구조](../figures/visual-v2/architecture.png)
...
![보안과 정상 완료의 관계](../figures/visual-v2/security-utility.png)
...
![시스템별 오류 유형](../figures/visual-v2/error-taxonomy.png)
...
![시스템별 지연 시간](../figures/visual-v2/latency.png)
